//package br.ihoje.crawler
//
//import java.net.URL
//import akka.actor.typed.scaladsl.{ ActorContext, Behaviors }
//import akka.actor.typed.{ ActorRef, Behavior }
//import br.ihoje.io.TSVWriter.IOCommand
//import br.ihoje.cache.WebCrawlerCache
//import br.ihoje.core.CrawledPageResult
//import br.ihoje.io.TSVWriter
//import br.ihoje.util.DomainRatioUtil
//
///**
...
//
//            if currentDepth == maxDepth then Behaviors.same
//            else if requestsInFlight(currentDepth) == 0 then
...
//            else crawling(currentDepth, maxDepth, requestsInFlight)
